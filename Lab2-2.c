...
void handle_srai(unsigned int cur_inst) {
    ...
    unsigned int rd = MASK11_7(cur_inst), rs1 = MASK19_15(cur_inst);
    int imm5 = MASK24_20(cur_inst);
    NEXT_LATCHES.REGS[rd] = ( ((int)CURRENT_LATCHES.REGS[rs1]) >> imm5 );
...
void handle_lui(unsigned int cur_inst) {
    ...
    unsigned imm20 = (MASK31_12(cur_inst) << 12);
...
void handle_jalr(unsigned int cur_inst) {
    ...
    NEXT_LATCHES.PC = ((CURRENT_LATCHES.REGS[rs1] + sext(imm12, 12)) & 0xFFFFFFFE); // set the LSB to 0
...
void handle_lh(unsigned int cur_inst) {
    ...
    int imm12 = MASK31_20(cur_inst);
    NEXT_LATCHES.REGS[rd] = MASK7_0(MEMORY[sext(imm12, 12) + CURRENT_LATCHES.REGS[rs1]]);
    NEXT_LATCHES.REGS[rd] += (MASK7_0(MEMORY[sext(imm12, 12) + CURRENT_LATCHES.REGS[rs1] + 1]) << 8);
...
void handle_lw(unsigned int cur_inst) {
    ...
    NEXT_LATCHES.REGS[rd] = MASK7_0(MEMORY[sext(imm12, 12) + CURRENT_LATCHES.REGS[rs1]]);
    NEXT_LATCHES.REGS[rd] += (MASK7_0(MEMORY[sext(imm12, 12) + CURRENT_LATCHES.REGS[rs1] + 1]) << 8);
    NEXT_LATCHES.REGS[rd] += (MASK7_0(MEMORY[sext(imm12, 12) + CURRENT_LATCHES.REGS[rs1] + 2]) << 16);
    NEXT_LATCHES.REGS[rd] += (MASK7_0(MEMORY[sext(imm12, 12) + CURRENT_LATCHES.REGS[rs1] + 3]) << 24);
...
void handle_sb(unsigned int cur_inst) {
     ...
     * Lab2-2 assignment
     */
    unsigned int rs2 = MASK24_20(cur_inst), rs1 = MASK19_15(cur_inst);
    int imm12 = (MASK31_25(cur_inst) << 5) + MASK11_7(cur_inst);
    MEMORY[imm12 + CURRENT_LATCHES.REGS[rs1]] = MASK7_0(CURRENT_LATCHES.REGS[rs2]);
...
void handle_sh(unsigned int cur_inst) {
    ...
    int imm12 = (MASK31_25(cur_inst) << 5) + MASK11_7(cur_inst);
    MEMORY[imm12 + CURRENT_LATCHES.REGS[rs1]] = MASK7_0(CURRENT_LATCHES.REGS[rs2]);
    MEMORY[imm12 + CURRENT_LATCHES.REGS[rs1] + 1] = MASK15_8(CURRENT_LATCHES.REGS[rs2]);
...
void handle_sw(unsigned int cur_inst) {
    ...
    MEMORY[imm12 + CURRENT_LATCHES.REGS[rs1]] = MASK7_0(CURRENT_LATCHES.REGS[rs2]);
    MEMORY[imm12 + CURRENT_LATCHES.REGS[rs1] + 1] = MASK15_8(CURRENT_LATCHES.REGS[rs2]);
    MEMORY[imm12 + CURRENT_LATCHES.REGS[rs1] + 2] = MASK23_16(CURRENT_LATCHES.REGS[rs2]);
    MEMORY[imm12 + CURRENT_LATCHES.REGS[rs1] + 3] = MASK31_24(CURRENT_LATCHES.REGS[rs2]);
